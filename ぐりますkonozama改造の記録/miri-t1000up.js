(function() {
    ...
    var page=[];for(var i=0;i<2;i++){page[i]=i+1;}
    ...
    var google="https://script.google.com/macros/s/AKfycbzOyyooQEH4MXwrKVaesmd5W-zH8AC4HhW0BqTjEvlpx9jqvdg/exec";
	...
	'http://imas.gree-apps.net/app/index.php/ranking/producer/segment/2/rank_page/'
	]
    ...
    function init(num) {
        ...
        progress.done(function(data100, dataown) {
            ...
            if (num > idolname.length) {
                ...
                TextDL(finishdata, "up-"+ dtstring(dd).replace(/[/ :\-]/g, "")+"-totalfan");
    ...
    function load(idol) {
        ...
        page.done(function(data) {
            ...
            $(dom).find('td').each(function() {            
                temp = $(this).html();
                if (temp.match(/txt-sub2/) != null  && temp.match(/[0-9]+位/)!= null && temp.match(/現在の順位&nbsp;/)== null) {
                //現在の順位&nbsp; href
