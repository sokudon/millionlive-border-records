(function() {
    ...
    var page=[];for(var i=0;i<600;i++){page[i]=i+1;}
    ...
    var google ="https://script.google.com/macros/s/AKfycbzhPlTs-JnUEke5etpQiCvuYmFBj1Ji56zYg-JFeFueDXW3KNM/exec"
    ...
    function init(num) {
        ...
        progress.done(function(data100, dataown) {
            ...
            if (num > idolname.length) {
                ...
                var dd = new Date();
                finishdata += "※" + dtstring(dd) + ' 集計時点 先週ランキング'+ credit +'\r\n';
                //alert(finishdata);
