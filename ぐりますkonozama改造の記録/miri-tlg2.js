(function() {
    ...
    var uribase = [
    "http://imas.gree-apps.net/app/index.php/friend/id_search/",
    "http://imas.gree-apps.net/app/index.php/mypage/mydata/"    ,
	'http://imas.gree-apps.net/app/index.php/event/' + eventid + '/ranking/lounge'+tyukan+'?page='
	]
   ...
   d.writeln("<pre>"+finishdata +"</pre>");
                ...
                TextDL(finishdata, dtstring(dd).replace(/[/ :\-]/g, "")+"-lg2");
    ...
    function load(idol) {
        ...
        page.done(function(data) {
			...
			if(mode==0){
			  $(dom).find('span.font-large').each(function() {            
                            temp = $(this).text();
                            if(temp.match(/[0-9]+/)!=null){
                            yourID=temp.match(/[0-9]+/);
                            }
            });
			}
			if(mode==1 && onece==0){
            ...
            $(dom).find('td').each(function() {            
                ...
                if (temp.match(/txt-sub2/) != null  && temp.match(/[0-9]+位/)!= null) {
                    ...
                    data100 = data100 + urank  + "\t"+ uname[1]  + "\t"+ uid[1]  + "\t"+ upt[1].replace(/,/g,"")  + "\r\n";
                }
            });
            }
