(function() {
    ...
    var page = [1,2, 10, 100, 500]; //らんきんぐのぺーじ 2まんなし
	...
	var tyukan= "";
	//var tyukan= "/half";
    var google ="https://script.google.com/macros/s/AKfycbzw_sDnlnIfoHwtmKk8LNeMvyUDHbm4MU5aue8GI9f2kJAGURk/exec";
	...
	'http://imas.gree-apps.net/app/index.php/ranking/appeal/segment/2/rank_page/'
	]
    ...
    function init(num) {
        ...
        progress.done(function(data100, dataown) {
            ...
            if (num > idolname.length) {
                ...
                TextDL(finishdata, dtstring(dd).replace(/[/ :\-]/g, "")+"-appeal");
    ...
    function load(idol) {
        ...
        page.done(function(data) {
            ...
            $(dom).find('td').each(function() {            
                temp = $(this).html();
                if (temp.match(/txt-sub2/) != null  && temp.match(/[0-9]+位/)!= null  && temp.match(/text-right/)!= null) {
                ...
                var rankst = rankfix.toString();
                   if(rankst.match(/(^1?1|0)$/) !=null){//1位,10位
                    ...
                    //uname = temp.match(/>(.*?)</);
                    //}                    
                    upt = temp.replace(/,/gm,"").match(/text-right\">([0-9]+)アピール</gm);
                    data100 = data100 
                    + rankfix+"位(" + urank + ")\t"
                    //+ uid[1]  + "\t"
                   // + uname[1]  + "\t"
