(function() {
    ...
    var idolname=[];
    for(var i=0;i<910;i++){idolname[i]=i+1;}//max997,1pt 530 ,imce3 821, ce2 864

    var eventid = 291; //いべんと番号
    var credit = 'BY SKDN';
    
    var uribase = 'http://imas.gree-apps.net/app/index.php/event/' + eventid + '/ranking/lounge?page=';
    ...
    function init(num) {
        ...
        progress.done(function(data100, dataown) {
            ...
            if (num > idolname.length) {
                ...
                TextDL(finishdata, dtstring(dd).replace(/[/ :\-]/g, "")+"-lgmax");
