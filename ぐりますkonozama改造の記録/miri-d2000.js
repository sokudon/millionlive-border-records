(function() {
    ...
    var yourID= "1300000000000004142";//しゅとくできなかったときのだみー
    ...
    function init(num) {
        ...
        progress.done(function(data100, dataown) {
            ...
            if (num > idolname.length) {
                ...
                TextDL(finishdata, dtstring(dd).replace(/[/ :\-]/g, "")+"-pt");
