(function() {
    ...
    "365",
    //"325", AS10だけ
    "330","310","296","277","250","233","219","199","186","176","149","134"];
    //,"123","110","100","93","90","85","73","59","47","32","17",7　おふしょなし
    ...
    var finishdata = '';
    uri = ["http://imas.gree-apps.net/app/index.php/event"
    ...
    uri[1]= "http://imas.gree-apps.net/app/index.php/featuring/index/event/"+eventid[idstep]+ "/from/memories/";
    uri[2]="http://imas.gree-apps.net/app/index.php/featuring/short_story/event/" + eventid[idstep] + "/from/memories";
        ...
        progress.done(function(data100, dataown) {
            ...
            if (idolname[num-1]==2) {
				...
				for(var i=0;i<5;i++){  //idolstage.length;i++){
                ...
                var
                    ...
                    d = w.document;
                //だうんろーどしょり   
                TextDL(finishdata , eventid[idstep] + ".html");
